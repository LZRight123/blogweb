      ...
      if (window.plus) {
        ...
        if (
          (a.webviews[f]
            ...
            : g.createNew !== !0 && (k = plus.webview.getWebviewById(f)),
          k)
        )
          return (
            (h = l ? l.show : c),
        ...
        if (window.plus) {
          ...
          if (
            (a.webviews[h]
              ...
              : b.createNew !== !0 && (l = plus.webview.getWebviewById(h)),
            l)
          )
            return (
              (i = m ? m.show : c),
